...
// -- Cognitive state --
// Attention probability of correctly predicted
const double pHH={attention_high_high};
const double pHL={attention_high_low};
const double pLH={attention_low_high};
const double pLL={attention_low_low}; //1-pHH-pHL-pLH;
// Understanding probability of correctly predicted
const double pHH_u={understanding_high_high};
const double pHL_u={understanding_high_low};
const double pLH_u={understanding_low_high};
const double pLL_u={understanding_low_low}; //1-pHH_u-pHL_u-pLH_u;
...
// -- Prompt filling options Acceptance/Rejection rates --
//-- level_of_detail -- a1: high_detail; a2: summary
// high_detail
const int prompt_accepted_a1 = {high_detail_acceptance};
const int prompt_rejected_a1 = {high_detail_rejection};
// summary
const int prompt_accepted_a2 = {summary_acceptance};
const int prompt_rejected_a2 = {summary_rejection};
//-- tone -- b1: precise; b2: casual
// precise
const int prompt_accepted_b1 = {precise_acceptance};
const int prompt_rejected_b1 = {precise_rejection};
// casual
const int prompt_accepted_b2 = {casual_acceptance};
const int prompt_rejected_b2 = {casual_rejection};
//-- format -- c1: list; c2: paragraph; c3: bullet
// list
const int prompt_accepted_c1 = {list_acceptance};
const int prompt_rejected_c1 = {list_rejection};
// paragraph
const int prompt_accepted_c2 = {paragraph_acceptance};
const int prompt_rejected_c2 = {paragraph_rejection};
// bullet
const int prompt_accepted_c3 = {bullet_acceptance};
const int prompt_rejected_c3 = {bullet_rejection};
