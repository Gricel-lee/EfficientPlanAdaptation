...
evolve int r3_maxRetry_t3l9a [1..10];
...
const double p_r3_t3l9a_ORIGINAL=0.97;
...
const double steepnessr3_t3l9a = 0.1;
...
formula p_r3_t3l9a = 2 * (1 - p_r3_t3l9a_ORIGINAL) * (1 / (1 + 1/pow(e,(r3retry_t3l9a * steepnessr3_t3l9a)))) + (2 * p_r3_t3l9a_ORIGINAL - 1);
...
module _worker1
  ...
  [worker1dot1l6aRetry] worker1=3 & worker1retry_t1l6a < worker1_maxRetry_t1l6a -> p_worker1_t1l6a : (worker1'=worker1+1) + (1-p_worker1_t1l6a) : (worker1'=worker1) & (worker1retry_t1l6a' = worker1retry_t1l6a+1);
  [worker1dot1l6a] worker1=3 & worker1retry_t1l6a >= worker1_maxRetry_t1l6a -> 1:(worker1'=worker1Fail);
  [worker1dot1l6bRetry] worker1=4 & worker1retry_t1l6b < worker1_maxRetry_t1l6b -> p_worker1_t1l6b : (worker1'=worker1+1) + (1-p_worker1_t1l6b) : (worker1'=worker1) & (worker1retry_t1l6b' = worker1retry_t1l6b+1);
  [worker1dot1l6b] worker1=4 & worker1retry_t1l6b >= worker1_maxRetry_t1l6b -> 1:(worker1'=worker1Fail);
endmodule
...
module _r3
  ...
  r3retry_t3l9a : [0..r3_maxRetry_t3l9a] init 0;
  ...
  [r3dot2l8dRetry] r3=4 & r3retry_t2l8d < r3_maxRetry_t2l8d -> p_r3_t2l8d : (r3'=r3+1) + (1-p_r3_t2l8d) : (r3'=r3) & (r3retry_t2l8d' = r3retry_t2l8d+1);
  [r3dot2l8d] r3=4 & r3retry_t2l8d >= r3_maxRetry_t2l8d -> 1:(r3'=r3Fail);
  [r3dot2l8cRetry] r3=5 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=5 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
  [r3dot3l8Retry] r3=6 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=6 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
  [r3movel9] r3=7-> 1:(r3'=7+1);
  [r3dot3l9bRetry] r3=8 & r3retry_t3l9b < r3_maxRetry_t3l9b -> p_r3_t3l9b : (r3'=r3+1) + (1-p_r3_t3l9b) : (r3'=r3) & (r3retry_t3l9b' = r3retry_t3l9b+1);
  [r3dot3l9b] r3=8 & r3retry_t3l9b >= r3_maxRetry_t3l9b -> 1:(r3'=r3Fail);
  [r3dot3l9aRetry] r3=9 & r3retry_t3l9a < r3_maxRetry_t3l9a -> p_r3_t3l9a : (r3'=r3+1) + (1-p_r3_t3l9a) : (r3'=r3) & (r3retry_t3l9a' = r3retry_t3l9a+1);
  [r3dot3l9a] r3=9 & r3retry_t3l9a >= r3_maxRetry_t3l9a -> 1:(r3'=r3Fail);
  [r3dot3l9Retry] r3=10 & r3retry_t3l9 < r3_maxRetry_t3l9 -> p_r3_t3l9 : (r3'=r3+1) + (1-p_r3_t3l9) : (r3'=r3) & (r3retry_t3l9' = r3retry_t3l9+1);
  [r3dot3l9] r3=10 & r3retry_t3l9 >= r3_maxRetry_t3l9 -> 1:(r3'=r3Fail);
  [r3movel8] r3=11-> 1:(r3'=11+1);
  [r3dot2l8aRetry] r3=12 & r3retry_t2l8a < r3_maxRetry_t2l8a -> p_r3_t2l8a : (r3'=r3+1) + (1-p_r3_t2l8a) : (r3'=r3) & (r3retry_t2l8a' = r3retry_t2l8a+1);
  [r3dot2l8a] r3=12 & r3retry_t2l8a >= r3_maxRetry_t2l8a -> 1:(r3'=r3Fail);
  [r3dot3l8bRetry] r3=13 & r3retry_t3l8b < r3_maxRetry_t3l8b -> p_r3_t3l8b : (r3'=r3+1) + (1-p_r3_t3l8b) : (r3'=r3) & (r3retry_t3l8b' = r3retry_t3l8b+1);
  [r3dot3l8b] r3=13 & r3retry_t3l8b >= r3_maxRetry_t3l8b -> 1:(r3'=r3Fail);
  [r3dot2l8bRetry] r3=14 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=14 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
endmodule
...
formula r_r3_t3l9a_ORIGINAL = 1;
formula r_r3_t3l9a = r_r3_t3l9a_ORIGINAL * (r3retry_t3l9a+1);
