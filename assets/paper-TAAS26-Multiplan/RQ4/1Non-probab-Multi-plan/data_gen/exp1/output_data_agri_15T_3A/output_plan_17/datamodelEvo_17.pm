...
const int worker1Final = 14;
const int worker1Fail = 15;
...
module _worker1
  ...
  [worker1dot1l6bRetry] worker1=9 & worker1retry_t1l6b < worker1_maxRetry_t1l6b -> p_worker1_t1l6b : (worker1'=worker1+1) + (1-p_worker1_t1l6b) : (worker1'=worker1) & (worker1retry_t1l6b' = worker1retry_t1l6b+1);
  [worker1dot1l6b] worker1=9 & worker1retry_t1l6b >= worker1_maxRetry_t1l6b -> 1:(worker1'=worker1Fail);
  ...
  [worker1dot3l9aRetry] worker1=12 & worker1retry_t3l9a < worker1_maxRetry_t3l9a -> p_worker1_t3l9a : (worker1'=worker1+1) + (1-p_worker1_t3l9a) : (worker1'=worker1) & (worker1retry_t3l9a' = worker1retry_t3l9a+1);
  [worker1dot3l9a] worker1=12 & worker1retry_t3l9a >= worker1_maxRetry_t3l9a -> 1:(worker1'=worker1Fail);
  [worker1dot3l9bRetry] worker1=13 & worker1retry_t3l9b < worker1_maxRetry_t3l9b -> p_worker1_t3l9b : (worker1'=worker1+1) + (1-p_worker1_t3l9b) : (worker1'=worker1) & (worker1retry_t3l9b' = worker1retry_t3l9b+1);
  [worker1dot3l9b] worker1=13 & worker1retry_t3l9b >= worker1_maxRetry_t3l9b -> 1:(worker1'=worker1Fail);
endmodule
