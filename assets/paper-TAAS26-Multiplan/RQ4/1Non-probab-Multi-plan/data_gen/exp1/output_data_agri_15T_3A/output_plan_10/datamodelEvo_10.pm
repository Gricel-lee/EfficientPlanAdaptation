...
module _worker1
  ...
  [worker1dot3l9aRetry] worker1=6 & worker1retry_t3l9a < worker1_maxRetry_t3l9a -> p_worker1_t3l9a : (worker1'=worker1+1) + (1-p_worker1_t3l9a) : (worker1'=worker1) & (worker1retry_t3l9a' = worker1retry_t3l9a+1);
  [worker1dot3l9a] worker1=6 & worker1retry_t3l9a >= worker1_maxRetry_t3l9a -> 1:(worker1'=worker1Fail);
