...
const double p_worker2_t3l9a_ORIGINAL=0.99;
...
const double steepnessworker2_t3l9a = 3;
...
formula p_worker2_t3l9a = 2 * (1 - p_worker2_t3l9a_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l9a * steepnessworker2_t3l9a)))) + (2 * p_worker2_t3l9a_ORIGINAL - 1);
...
module _worker2
  ...
  [worker2dot3l9aRetry] worker2=5 & worker2retry_t3l9a < worker2_maxRetry_t3l9a -> p_worker2_t3l9a : (worker2'=worker2+1) + (1-p_worker2_t3l9a) : (worker2'=worker2) & (worker2retry_t3l9a' = worker2retry_t3l9a+1);
  [worker2dot3l9a] worker2=5 & worker2retry_t3l9a >= worker2_maxRetry_t3l9a -> 1:(worker2'=worker2Fail);
  ...
  [worker2dot3l9bRetry] worker2=7 & worker2retry_t3l9b < worker2_maxRetry_t3l9b -> p_worker2_t3l9b : (worker2'=worker2+1) + (1-p_worker2_t3l9b) : (worker2'=worker2) & (worker2retry_t3l9b' = worker2retry_t3l9b+1);
  [worker2dot3l9b] worker2=7 & worker2retry_t3l9b >= worker2_maxRetry_t3l9b -> 1:(worker2'=worker2Fail);
  [worker2movel6] worker2=8-> 1:(worker2'=8+1);
  [worker2dot1l6bRetry] worker2=9 & worker2retry_t1l6b < worker2_maxRetry_t1l6b -> p_worker2_t1l6b : (worker2'=worker2+1) + (1-p_worker2_t1l6b) : (worker2'=worker2) & (worker2retry_t1l6b' = worker2retry_t1l6b+1);
  [worker2dot1l6b] worker2=9 & worker2retry_t1l6b >= worker2_maxRetry_t1l6b -> 1:(worker2'=worker2Fail);
endmodule
...
module _r3
  ...
  [r3dot2l8cRetry] r3=4 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=4 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
  ...
  [r3dot3l8bRetry] r3=8 & r3retry_t3l8b < r3_maxRetry_t3l8b -> p_r3_t3l8b : (r3'=r3+1) + (1-p_r3_t3l8b) : (r3'=r3) & (r3retry_t3l8b' = r3retry_t3l8b+1);
  [r3dot3l8b] r3=8 & r3retry_t3l8b >= r3_maxRetry_t3l8b -> 1:(r3'=r3Fail);
...
formula r_worker2_t3l9a_ORIGINAL = 5;
formula r_worker2_t3l9a = r_worker2_t3l9a_ORIGINAL * (worker2retry_t3l9a+1);
