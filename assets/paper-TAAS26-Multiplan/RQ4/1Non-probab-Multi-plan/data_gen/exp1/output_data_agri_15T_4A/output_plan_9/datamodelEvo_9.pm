...
module _r3
  ...
  [r3dot3l8Retry] r3=4 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=4 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
  ...
  [r3dot2l8bRetry] r3=12 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=12 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
endmodule
