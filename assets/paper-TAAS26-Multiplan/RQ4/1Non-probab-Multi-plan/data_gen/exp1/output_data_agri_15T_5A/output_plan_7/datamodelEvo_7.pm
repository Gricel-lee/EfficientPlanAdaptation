...
module _worker1
  ...
  [worker1movel4] worker1=6-> 1:(worker1'=6+1);
endmodule
...
module _r3
  ...
  [r3dot3l8Retry] r3=8 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=8 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
