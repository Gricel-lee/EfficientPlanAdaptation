...
module _r5
  ...
  [r5dot3l8bRetry] r5=5 & r5retry_t3l8b < r5_maxRetry_t3l8b -> p_r5_t3l8b : (r5'=r5+1) + (1-p_r5_t3l8b) : (r5'=r5) & (r5retry_t3l8b' = r5retry_t3l8b+1);
  [r5dot3l8b] r5=5 & r5retry_t3l8b >= r5_maxRetry_t3l8b -> 1:(r5'=r5Fail);
  ...
  [r5dot2l8dRetry] r5=7 & r5retry_t2l8d < r5_maxRetry_t2l8d -> p_r5_t2l8d : (r5'=r5+1) + (1-p_r5_t2l8d) : (r5'=r5) & (r5retry_t2l8d' = r5retry_t2l8d+1);
  [r5dot2l8d] r5=7 & r5retry_t2l8d >= r5_maxRetry_t2l8d -> 1:(r5'=r5Fail);
  [r5dot3l8Retry] r5=8 & r5retry_t3l8 < r5_maxRetry_t3l8 -> p_r5_t3l8 : (r5'=r5+1) + (1-p_r5_t3l8) : (r5'=r5) & (r5retry_t3l8' = r5retry_t3l8+1);
  [r5dot3l8] r5=8 & r5retry_t3l8 >= r5_maxRetry_t3l8 -> 1:(r5'=r5Fail);
  [r5dot2l8bRetry] r5=9 & r5retry_t2l8b < r5_maxRetry_t2l8b -> p_r5_t2l8b : (r5'=r5+1) + (1-p_r5_t2l8b) : (r5'=r5) & (r5retry_t2l8b' = r5retry_t2l8b+1);
  [r5dot2l8b] r5=9 & r5retry_t2l8b >= r5_maxRetry_t2l8b -> 1:(r5'=r5Fail);
endmodule
...
module _worker1
  ...
  [worker1dot3l9bRetry] worker1=7 & worker1retry_t3l9b < worker1_maxRetry_t3l9b -> p_worker1_t3l9b : (worker1'=worker1+1) + (1-p_worker1_t3l9b) : (worker1'=worker1) & (worker1retry_t3l9b' = worker1retry_t3l9b+1);
  [worker1dot3l9b] worker1=7 & worker1retry_t3l9b >= worker1_maxRetry_t3l9b -> 1:(worker1'=worker1Fail);
endmodule
