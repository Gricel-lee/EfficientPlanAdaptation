...
module _r3
  ...
  [r3dot3l9bRetry] r3=5 & r3retry_t3l9b < r3_maxRetry_t3l9b -> p_r3_t3l9b : (r3'=r3+1) + (1-p_r3_t3l9b) : (r3'=r3) & (r3retry_t3l9b' = r3retry_t3l9b+1);
  [r3dot3l9b] r3=5 & r3retry_t3l9b >= r3_maxRetry_t3l9b -> 1:(r3'=r3Fail);
  [r3dot3l9aRetry] r3=6 & r3retry_t3l9a < r3_maxRetry_t3l9a -> p_r3_t3l9a : (r3'=r3+1) + (1-p_r3_t3l9a) : (r3'=r3) & (r3retry_t3l9a' = r3retry_t3l9a+1);
  [r3dot3l9a] r3=6 & r3retry_t3l9a >= r3_maxRetry_t3l9a -> 1:(r3'=r3Fail);
  ...
  [r3dot2l8cRetry] r3=11 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=11 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
  ...
  [r3dot3l8Retry] r3=14 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=14 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
endmodule
