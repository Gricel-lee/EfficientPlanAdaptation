...
module _worker2
  ...
  [worker2dot3l9aRetry] worker2=6 & worker2retry_t3l9a < worker2_maxRetry_t3l9a -> p_worker2_t3l9a : (worker2'=worker2+1) + (1-p_worker2_t3l9a) : (worker2'=worker2) & (worker2retry_t3l9a' = worker2retry_t3l9a+1);
  [worker2dot3l9a] worker2=6 & worker2retry_t3l9a >= worker2_maxRetry_t3l9a -> 1:(worker2'=worker2Fail);
