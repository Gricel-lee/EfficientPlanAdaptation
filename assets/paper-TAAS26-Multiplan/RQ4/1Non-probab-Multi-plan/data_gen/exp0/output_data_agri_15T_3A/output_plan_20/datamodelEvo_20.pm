...
const double p_worker2_t3l8b_ORIGINAL=0.99;
...
const double steepnessworker2_t3l8b = 3;
...
formula p_worker2_t3l8b = 2 * (1 - p_worker2_t3l8b_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l8b * steepnessworker2_t3l8b)))) + (2 * p_worker2_t3l8b_ORIGINAL - 1);
...
module _worker2
  ...
  [worker2dot3l8bRetry] worker2=6 & worker2retry_t3l8b < worker2_maxRetry_t3l8b -> p_worker2_t3l8b : (worker2'=worker2+1) + (1-p_worker2_t3l8b) : (worker2'=worker2) & (worker2retry_t3l8b' = worker2retry_t3l8b+1);
  [worker2dot3l8b] worker2=6 & worker2retry_t3l8b >= worker2_maxRetry_t3l8b -> 1:(worker2'=worker2Fail);
  ...
  [worker2movel7] worker2=8-> 1:(worker2'=8+1);
  [worker2dot1l7Retry] worker2=9 & worker2retry_t1l7 < worker2_maxRetry_t1l7 -> p_worker2_t1l7 : (worker2'=worker2+1) + (1-p_worker2_t1l7) : (worker2'=worker2) & (worker2retry_t1l7' = worker2retry_t1l7+1);
  [worker2dot1l7] worker2=9 & worker2retry_t1l7 >= worker2_maxRetry_t1l7 -> 1:(worker2'=worker2Fail);
endmodule
...
module _r3
  ...
  [r3dot3l9aRetry] r3=10 & r3retry_t3l9a < r3_maxRetry_t3l9a -> p_r3_t3l9a : (r3'=r3+1) + (1-p_r3_t3l9a) : (r3'=r3) & (r3retry_t3l9a' = r3retry_t3l9a+1);
  [r3dot3l9a] r3=10 & r3retry_t3l9a >= r3_maxRetry_t3l9a -> 1:(r3'=r3Fail);
...
formula r_worker2_t3l8b_ORIGINAL = 5;
formula r_worker2_t3l8b = r_worker2_t3l8b_ORIGINAL * (worker2retry_t3l8b+1);
