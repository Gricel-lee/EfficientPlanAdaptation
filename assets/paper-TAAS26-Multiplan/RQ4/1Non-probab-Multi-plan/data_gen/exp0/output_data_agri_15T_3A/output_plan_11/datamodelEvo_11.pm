...
module _worker2
  ...
  [worker2dot3l9aRetry] worker2=10 & worker2retry_t3l9a < worker2_maxRetry_t3l9a -> p_worker2_t3l9a : (worker2'=worker2+1) + (1-p_worker2_t3l9a) : (worker2'=worker2) & (worker2retry_t3l9a' = worker2retry_t3l9a+1);
  [worker2dot3l9a] worker2=10 & worker2retry_t3l9a >= worker2_maxRetry_t3l9a -> 1:(worker2'=worker2Fail);
  [worker2dot3l9Retry] worker2=11 & worker2retry_t3l9 < worker2_maxRetry_t3l9 -> p_worker2_t3l9 : (worker2'=worker2+1) + (1-p_worker2_t3l9) : (worker2'=worker2) & (worker2retry_t3l9' = worker2retry_t3l9+1);
  [worker2dot3l9] worker2=11 & worker2retry_t3l9 >= worker2_maxRetry_t3l9 -> 1:(worker2'=worker2Fail);
  [worker2dot3l9bRetry] worker2=12 & worker2retry_t3l9b < worker2_maxRetry_t3l9b -> p_worker2_t3l9b : (worker2'=worker2+1) + (1-p_worker2_t3l9b) : (worker2'=worker2) & (worker2retry_t3l9b' = worker2retry_t3l9b+1);
  [worker2dot3l9b] worker2=12 & worker2retry_t3l9b >= worker2_maxRetry_t3l9b -> 1:(worker2'=worker2Fail);
endmodule
...
module _r3
  ...
  [r3dot2l8bRetry] r3=7 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=7 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
  ...
  [r3movel7] r3=10-> 1:(r3'=10+1);
  [r3dot3l7Retry] r3=11 & r3retry_t3l7 < r3_maxRetry_t3l7 -> p_r3_t3l7 : (r3'=r3+1) + (1-p_r3_t3l7) : (r3'=r3) & (r3retry_t3l7' = r3retry_t3l7+1);
  [r3dot3l7] r3=11 & r3retry_t3l7 >= r3_maxRetry_t3l7 -> 1:(r3'=r3Fail);
endmodule
