...
evolve int r3_maxRetry_t3l8 [1..10];
evolve int r3_maxRetry_t2l8b [1..10];
evolve int r3_maxRetry_t2l8a [1..10];
evolve int r3_maxRetry_t2l8d [1..10];
evolve int r3_maxRetry_t2l8c [1..10];

const double p_worker1_t1l6b_ORIGINAL=1.0;
const double p_worker1_t3l9a_ORIGINAL=0.99;
const double p_worker1_t3l9b_ORIGINAL=0.99;
const double p_worker1_t3l9_ORIGINAL=0.99;
...
const double p_r3_t3l8_ORIGINAL=0.97;
const double p_r3_t2l8b_ORIGINAL=0.99;
const double p_r3_t2l8a_ORIGINAL=0.99;
const double p_r3_t2l8d_ORIGINAL=0.99;
const double p_r3_t2l8c_ORIGINAL=0.99;

const double e = 2.718281828459045;
const double steepnessworker1_t1l6b = 3;
const double steepnessworker1_t3l9a = 3;
const double steepnessworker1_t3l9b = 3;
const double steepnessworker1_t3l9 = 3;
...
formula p_worker1_t3l9a = 2 * (1 - p_worker1_t3l9a_ORIGINAL) * (1 / (1 + 1/pow(e,(worker1retry_t3l9a * steepnessworker1_t3l9a)))) + (2 * p_worker1_t3l9a_ORIGINAL - 1);
formula p_worker1_t3l9b = 2 * (1 - p_worker1_t3l9b_ORIGINAL) * (1 / (1 + 1/pow(e,(worker1retry_t3l9b * steepnessworker1_t3l9b)))) + (2 * p_worker1_t3l9b_ORIGINAL - 1);
formula p_worker1_t3l9 = 2 * (1 - p_worker1_t3l9_ORIGINAL) * (1 / (1 + 1/pow(e,(worker1retry_t3l9 * steepnessworker1_t3l9)))) + (2 * p_worker1_t3l9_ORIGINAL - 1);
...
formula p_r3_t3l8 = 2 * (1 - p_r3_t3l8_ORIGINAL) * (1 / (1 + 1/pow(e,(r3retry_t3l8 * steepnessr3_t3l8)))) + (2 * p_r3_t3l8_ORIGINAL - 1);
...
formula p_r3_t2l8c = 2 * (1 - p_r3_t2l8c_ORIGINAL) * (1 / (1 + 1/pow(e,(r3retry_t2l8c * steepnessr3_t2l8c)))) + (2 * p_r3_t2l8c_ORIGINAL - 1);
...
module _worker1
  ...
  [worker1dot3l9aRetry] worker1=5 & worker1retry_t3l9a < worker1_maxRetry_t3l9a -> p_worker1_t3l9a : (worker1'=worker1+1) + (1-p_worker1_t3l9a) : (worker1'=worker1) & (worker1retry_t3l9a' = worker1retry_t3l9a+1);
  [worker1dot3l9a] worker1=5 & worker1retry_t3l9a >= worker1_maxRetry_t3l9a -> 1:(worker1'=worker1Fail);
  [worker1dot3l9bRetry] worker1=6 & worker1retry_t3l9b < worker1_maxRetry_t3l9b -> p_worker1_t3l9b : (worker1'=worker1+1) + (1-p_worker1_t3l9b) : (worker1'=worker1) & (worker1retry_t3l9b' = worker1retry_t3l9b+1);
  [worker1dot3l9b] worker1=6 & worker1retry_t3l9b >= worker1_maxRetry_t3l9b -> 1:(worker1'=worker1Fail);
  ...
  [worker1dot1l6aRetry] worker1=9 & worker1retry_t1l6a < worker1_maxRetry_t1l6a -> p_worker1_t1l6a : (worker1'=worker1+1) + (1-p_worker1_t1l6a) : (worker1'=worker1) & (worker1retry_t1l6a' = worker1retry_t1l6a+1);
  [worker1dot1l6a] worker1=9 & worker1retry_t1l6a >= worker1_maxRetry_t1l6a -> 1:(worker1'=worker1Fail);
endmodule
...
module _r3
  ...
  [r3dot3l8Retry] r3=5 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=5 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
  [r3dot2l8bRetry] r3=6 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=6 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
  [r3dot2l8aRetry] r3=7 & r3retry_t2l8a < r3_maxRetry_t2l8a -> p_r3_t2l8a : (r3'=r3+1) + (1-p_r3_t2l8a) : (r3'=r3) & (r3retry_t2l8a' = r3retry_t2l8a+1);
  [r3dot2l8a] r3=7 & r3retry_t2l8a >= r3_maxRetry_t2l8a -> 1:(r3'=r3Fail);
  [r3dot2l8dRetry] r3=8 & r3retry_t2l8d < r3_maxRetry_t2l8d -> p_r3_t2l8d : (r3'=r3+1) + (1-p_r3_t2l8d) : (r3'=r3) & (r3retry_t2l8d' = r3retry_t2l8d+1);
  [r3dot2l8d] r3=8 & r3retry_t2l8d >= r3_maxRetry_t2l8d -> 1:(r3'=r3Fail);
  [r3dot2l8cRetry] r3=9 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=9 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
endmodule

formula r_worker1_t1l6b_ORIGINAL = 3;
formula r_worker1_t1l6b = r_worker1_t1l6b_ORIGINAL * (worker1retry_t1l6b+1);
formula r_worker1_t3l9a_ORIGINAL = 5;
formula r_worker1_t3l9a = r_worker1_t3l9a_ORIGINAL * (worker1retry_t3l9a+1);
formula r_worker1_t3l9b_ORIGINAL = 5;
formula r_worker1_t3l9b = r_worker1_t3l9b_ORIGINAL * (worker1retry_t3l9b+1);
formula r_worker1_t3l9_ORIGINAL = 5;
formula r_worker1_t3l9 = r_worker1_t3l9_ORIGINAL * (worker1retry_t3l9+1);
...
formula r_r3_t3l8_ORIGINAL = 1;
formula r_r3_t3l8 = r_r3_t3l8_ORIGINAL * (r3retry_t3l8+1);
...
formula r_r3_t2l8c_ORIGINAL = 1;
formula r_r3_t2l8c = r_r3_t2l8c_ORIGINAL * (r3retry_t2l8c+1);
