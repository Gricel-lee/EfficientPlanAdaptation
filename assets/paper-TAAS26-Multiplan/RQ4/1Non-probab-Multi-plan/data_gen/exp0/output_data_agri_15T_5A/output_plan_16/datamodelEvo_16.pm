...
evolve int r4_maxRetry_t3l9b [1..10];
evolve int r4_maxRetry_t3l9 [1..10];
...
const double p_r4_t3l9b_ORIGINAL=0.97;
const double p_r4_t3l9_ORIGINAL=0.97;
...
const double steepnessr4_t3l9b = 0.1;
const double steepnessr4_t3l9 = 0.1;
...
formula p_r4_t3l9b = 2 * (1 - p_r4_t3l9b_ORIGINAL) * (1 / (1 + 1/pow(e,(r4retry_t3l9b * steepnessr4_t3l9b)))) + (2 * p_r4_t3l9b_ORIGINAL - 1);
formula p_r4_t3l9 = 2 * (1 - p_r4_t3l9_ORIGINAL) * (1 / (1 + 1/pow(e,(r4retry_t3l9 * steepnessr4_t3l9)))) + (2 * p_r4_t3l9_ORIGINAL - 1);
...
module _worker2
  ...
  [worker2dot1l6aRetry] worker2=3 & worker2retry_t1l6a < worker2_maxRetry_t1l6a -> p_worker2_t1l6a : (worker2'=worker2+1) + (1-p_worker2_t1l6a) : (worker2'=worker2) & (worker2retry_t1l6a' = worker2retry_t1l6a+1);
  [worker2dot1l6a] worker2=3 & worker2retry_t1l6a >= worker2_maxRetry_t1l6a -> 1:(worker2'=worker2Fail);
  [worker2dot1l6bRetry] worker2=4 & worker2retry_t1l6b < worker2_maxRetry_t1l6b -> p_worker2_t1l6b : (worker2'=worker2+1) + (1-p_worker2_t1l6b) : (worker2'=worker2) & (worker2retry_t1l6b' = worker2retry_t1l6b+1);
  [worker2dot1l6b] worker2=4 & worker2retry_t1l6b >= worker2_maxRetry_t1l6b -> 1:(worker2'=worker2Fail);
endmodule
...
module _r3
  ...
  [r3dot2l8dRetry] r3=7 & r3retry_t2l8d < r3_maxRetry_t2l8d -> p_r3_t2l8d : (r3'=r3+1) + (1-p_r3_t2l8d) : (r3'=r3) & (r3retry_t2l8d' = r3retry_t2l8d+1);
  [r3dot2l8d] r3=7 & r3retry_t2l8d >= r3_maxRetry_t2l8d -> 1:(r3'=r3Fail);
  ...
  [r3dot3l8Retry] r3=9 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=9 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
endmodule

module _r4
  r4 : [0..8];
  r4retry_t3l9b : [0..r4_maxRetry_t3l9b] init 0;
  r4retry_t3l9 : [0..r4_maxRetry_t3l9] init 0;

  [r4movel2] r4=0-> 1:(r4'=0+1);
  [r4movel3] r4=1-> 1:(r4'=1+1);
  [r4movel6] r4=2-> 1:(r4'=2+1);
  [r4movel9] r4=3-> 1:(r4'=3+1);
  [r4dot3l9bRetry] r4=4 & r4retry_t3l9b < r4_maxRetry_t3l9b -> p_r4_t3l9b : (r4'=r4+1) + (1-p_r4_t3l9b) : (r4'=r4) & (r4retry_t3l9b' = r4retry_t3l9b+1);
  [r4dot3l9b] r4=4 & r4retry_t3l9b >= r4_maxRetry_t3l9b -> 1:(r4'=r4Fail);
  [r4dot3l9Retry] r4=5 & r4retry_t3l9 < r4_maxRetry_t3l9 -> p_r4_t3l9 : (r4'=r4+1) + (1-p_r4_t3l9) : (r4'=r4) & (r4retry_t3l9' = r4retry_t3l9+1);
  [r4dot3l9] r4=5 & r4retry_t3l9 >= r4_maxRetry_t3l9 -> 1:(r4'=r4Fail);
endmodule
...
formula r_r4_t3l9b_ORIGINAL = 1;
formula r_r4_t3l9b = r_r4_t3l9b_ORIGINAL * (r4retry_t3l9b+1);
formula r_r4_t3l9_ORIGINAL = 1;
formula r_r4_t3l9 = r_r4_t3l9_ORIGINAL * (r4retry_t3l9+1);
...
rewards "cost"
  ...
  [r4movel9] true:1;
  [r4dot3l9b] true:1;
  [r4dot3l9bRetry] true:1;
  [r4dot3l9] true:1;
  [r4dot3l9Retry] true:1;
endrewards