...
const double steepnessworker1_t1l6a = 1.0;
const double steepnessworker1_t1l6b = 1.0;
const double steepnessworker1_t3l9b = 1.0;
const double steepnessworker1_t3l9 = 1.0;
...
module _r3
  ...
  [r3dot3l8bRetry] r3=5 & r3retry_t3l8b < r3_maxRetry_t3l8b -> p_r3_t3l8b : (r3'=r3+1) + (1-p_r3_t3l8b) : (r3'=r3) & (r3retry_t3l8b' = r3retry_t3l8b+1);
  [r3dot3l8b] r3=5 & r3retry_t3l8b >= r3_maxRetry_t3l8b -> 1:(r3'=r3Fail);
  ...
  [r3dot3l8Retry] r3=7 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=7 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
  [r3dot2l8cRetry] r3=8 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=8 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
  [r3dot2l8bRetry] r3=9 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=9 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
endmodule
