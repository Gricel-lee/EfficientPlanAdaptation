...
module _r4
  ...
  [r4dot3l8Retry] r4=4 & r4retry_t3l8 < r4_maxRetry_t3l8 -> p_r4_t3l8 : (r4'=r4+1) + (1-p_r4_t3l8) : (r4'=r4) & (r4retry_t3l8' = r4retry_t3l8+1);
  [r4dot3l8] r4=4 & r4retry_t3l8 >= r4_maxRetry_t3l8 -> 1:(r4'=r4Fail);
  ...
  [r4dot2l8aRetry] r4=7 & r4retry_t2l8a < r4_maxRetry_t2l8a -> p_r4_t2l8a : (r4'=r4+1) + (1-p_r4_t2l8a) : (r4'=r4) & (r4retry_t2l8a' = r4retry_t2l8a+1);
  [r4dot2l8a] r4=7 & r4retry_t2l8a >= r4_maxRetry_t2l8a -> 1:(r4'=r4Fail);
  [r4dot3l8bRetry] r4=8 & r4retry_t3l8b < r4_maxRetry_t3l8b -> p_r4_t3l8b : (r4'=r4+1) + (1-p_r4_t3l8b) : (r4'=r4) & (r4retry_t3l8b' = r4retry_t3l8b+1);
  [r4dot3l8b] r4=8 & r4retry_t3l8b >= r4_maxRetry_t3l8b -> 1:(r4'=r4Fail);
  [r4dot2l8bRetry] r4=9 & r4retry_t2l8b < r4_maxRetry_t2l8b -> p_r4_t2l8b : (r4'=r4+1) + (1-p_r4_t2l8b) : (r4'=r4) & (r4retry_t2l8b' = r4retry_t2l8b+1);
  [r4dot2l8b] r4=9 & r4retry_t2l8b >= r4_maxRetry_t2l8b -> 1:(r4'=r4Fail);
endmodule
