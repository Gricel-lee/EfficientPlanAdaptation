...
module _r4
  ...
  [r4movel9] r4=5-> 1:(r4'=5+1);
  [r4dot3l9bRetry] r4=6 & r4retry_t3l9b < r4_maxRetry_t3l9b -> p_r4_t3l9b : (r4'=r4+1) + (1-p_r4_t3l9b) : (r4'=r4) & (r4retry_t3l9b' = r4retry_t3l9b+1);
  [r4dot3l9b] r4=6 & r4retry_t3l9b >= r4_maxRetry_t3l9b -> 1:(r4'=r4Fail);
  ...
  [r4dot3l8bRetry] r4=9 & r4retry_t3l8b < r4_maxRetry_t3l8b -> p_r4_t3l8b : (r4'=r4+1) + (1-p_r4_t3l8b) : (r4'=r4) & (r4retry_t3l8b' = r4retry_t3l8b+1);
  [r4dot3l8b] r4=9 & r4retry_t3l8b >= r4_maxRetry_t3l8b -> 1:(r4'=r4Fail);
  [r4dot2l8aRetry] r4=10 & r4retry_t2l8a < r4_maxRetry_t2l8a -> p_r4_t2l8a : (r4'=r4+1) + (1-p_r4_t2l8a) : (r4'=r4) & (r4retry_t2l8a' = r4retry_t2l8a+1);
  [r4dot2l8a] r4=10 & r4retry_t2l8a >= r4_maxRetry_t2l8a -> 1:(r4'=r4Fail);
  ...
  [r4dot3l8Retry] r4=13 & r4retry_t3l8 < r4_maxRetry_t3l8 -> p_r4_t3l8 : (r4'=r4+1) + (1-p_r4_t3l8) : (r4'=r4) & (r4retry_t3l8' = r4retry_t3l8+1);
  [r4dot3l8] r4=13 & r4retry_t3l8 >= r4_maxRetry_t3l8 -> 1:(r4'=r4Fail);
endmodule
