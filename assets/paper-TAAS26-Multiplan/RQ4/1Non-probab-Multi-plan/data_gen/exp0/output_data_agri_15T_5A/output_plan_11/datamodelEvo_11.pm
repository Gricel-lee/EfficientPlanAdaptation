...
module _r3
  ...
  [r3dot3l9bRetry] r3=11 & r3retry_t3l9b < r3_maxRetry_t3l9b -> p_r3_t3l9b : (r3'=r3+1) + (1-p_r3_t3l9b) : (r3'=r3) & (r3retry_t3l9b' = r3retry_t3l9b+1);
  [r3dot3l9b] r3=11 & r3retry_t3l9b >= r3_maxRetry_t3l9b -> 1:(r3'=r3Fail);
endmodule
