...
module _r5
  ...
  [r5movel3] r5=1-> 1:(r5'=1+1);
  [r5movel6] r5=2-> 1:(r5'=2+1);
  [r5movel9] r5=3-> 1:(r5'=3+1);
  [r5dot3l9bRetry] r5=4 & r5retry_t3l9b < r5_maxRetry_t3l9b -> p_r5_t3l9b : (r5'=r5+1) + (1-p_r5_t3l9b) : (r5'=r5) & (r5retry_t3l9b' = r5retry_t3l9b+1);
  [r5dot3l9b] r5=4 & r5retry_t3l9b >= r5_maxRetry_t3l9b -> 1:(r5'=r5Fail);
  [r5dot3l9Retry] r5=5 & r5retry_t3l9 < r5_maxRetry_t3l9 -> p_r5_t3l9 : (r5'=r5+1) + (1-p_r5_t3l9) : (r5'=r5) & (r5retry_t3l9' = r5retry_t3l9+1);
  [r5dot3l9] r5=5 & r5retry_t3l9 >= r5_maxRetry_t3l9 -> 1:(r5'=r5Fail);
endmodule
