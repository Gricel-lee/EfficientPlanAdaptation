...
module _r3
  ...
  [r3dot3l8bRetry] r3=6 & r3retry_t3l8b < r3_maxRetry_t3l8b -> p_r3_t3l8b : (r3'=r3+1) + (1-p_r3_t3l8b) : (r3'=r3) & (r3retry_t3l8b' = r3retry_t3l8b+1);
  [r3dot3l8b] r3=6 & r3retry_t3l8b >= r3_maxRetry_t3l8b -> 1:(r3'=r3Fail);
