...
const double p_worker2_t3l8_ORIGINAL=0.99;
...
const double steepnessworker2_t3l8 = 3;
...
formula p_worker2_t3l8 = 2 * (1 - p_worker2_t3l8_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l8 * steepnessworker2_t3l8)))) + (2 * p_worker2_t3l8_ORIGINAL - 1);
...
module _worker1
  ...
  [worker1dot1l6aRetry] worker1=8 & worker1retry_t1l6a < worker1_maxRetry_t1l6a -> p_worker1_t1l6a : (worker1'=worker1+1) + (1-p_worker1_t1l6a) : (worker1'=worker1) & (worker1retry_t1l6a' = worker1retry_t1l6a+1);
  [worker1dot1l6a] worker1=8 & worker1retry_t1l6a >= worker1_maxRetry_t1l6a -> 1:(worker1'=worker1Fail);
endmodule
...
module _r3
  ...
  [r3dot2l8bRetry] r3=5 & r3retry_t2l8b < r3_maxRetry_t2l8b -> p_r3_t2l8b : (r3'=r3+1) + (1-p_r3_t2l8b) : (r3'=r3) & (r3retry_t2l8b' = r3retry_t2l8b+1);
  [r3dot2l8b] r3=5 & r3retry_t2l8b >= r3_maxRetry_t2l8b -> 1:(r3'=r3Fail);
  [r3dot2l8dRetry] r3=6 & r3retry_t2l8d < r3_maxRetry_t2l8d -> p_r3_t2l8d : (r3'=r3+1) + (1-p_r3_t2l8d) : (r3'=r3) & (r3retry_t2l8d' = r3retry_t2l8d+1);
  [r3dot2l8d] r3=6 & r3retry_t2l8d >= r3_maxRetry_t2l8d -> 1:(r3'=r3Fail);
...
formula r_worker2_t3l8_ORIGINAL = 5;
formula r_worker2_t3l8 = r_worker2_t3l8_ORIGINAL * (worker2retry_t3l8+1);
