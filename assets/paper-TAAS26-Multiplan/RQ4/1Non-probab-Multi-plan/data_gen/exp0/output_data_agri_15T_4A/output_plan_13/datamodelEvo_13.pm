...
module _worker2
  ...
  [worker2dot3l9Retry] worker2=5 & worker2retry_t3l9 < worker2_maxRetry_t3l9 -> p_worker2_t3l9 : (worker2'=worker2+1) + (1-p_worker2_t3l9) : (worker2'=worker2) & (worker2retry_t3l9' = worker2retry_t3l9+1);
  [worker2dot3l9] worker2=5 & worker2retry_t3l9 >= worker2_maxRetry_t3l9 -> 1:(worker2'=worker2Fail);
...
module _r4
  ...
  [r4dot3l8Retry] r4=7 & r4retry_t3l8 < r4_maxRetry_t3l8 -> p_r4_t3l8 : (r4'=r4+1) + (1-p_r4_t3l8) : (r4'=r4) & (r4retry_t3l8' = r4retry_t3l8+1);
  [r4dot3l8] r4=7 & r4retry_t3l8 >= r4_maxRetry_t3l8 -> 1:(r4'=r4Fail);
