...
module _worker2
  ...
  [worker2dot3l9bRetry] worker2=6 & worker2retry_t3l9b < worker2_maxRetry_t3l9b -> p_worker2_t3l9b : (worker2'=worker2+1) + (1-p_worker2_t3l9b) : (worker2'=worker2) & (worker2retry_t3l9b' = worker2retry_t3l9b+1);
  [worker2dot3l9b] worker2=6 & worker2retry_t3l9b >= worker2_maxRetry_t3l9b -> 1:(worker2'=worker2Fail);
...
module _r3
  ...
  [r3dot2l8aRetry] r3=8 & r3retry_t2l8a < r3_maxRetry_t2l8a -> p_r3_t2l8a : (r3'=r3+1) + (1-p_r3_t2l8a) : (r3'=r3) & (r3retry_t2l8a' = r3retry_t2l8a+1);
  [r3dot2l8a] r3=8 & r3retry_t2l8a >= r3_maxRetry_t2l8a -> 1:(r3'=r3Fail);
