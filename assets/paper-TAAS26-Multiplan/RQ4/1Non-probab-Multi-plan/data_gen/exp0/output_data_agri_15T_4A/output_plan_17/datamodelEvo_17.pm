...
module _worker1
  ...
  [worker1movel4] worker1=5-> 1:(worker1'=5+1);
  ...
  [worker1dot1l6b] worker1=8 & worker1retry_t1l6b >= worker1_maxRetry_t1l6b -> 1:(worker1'=worker1Fail);
  ...
  [worker1dot3l9bRetry] worker1=12 & worker1retry_t3l9b < worker1_maxRetry_t3l9b -> p_worker1_t3l9b : (worker1'=worker1+1) + (1-p_worker1_t3l9b) : (worker1'=worker1) & (worker1retry_t3l9b' = worker1retry_t3l9b+1);
  [worker1dot3l9b] worker1=12 & worker1retry_t3l9b >= worker1_maxRetry_t3l9b -> 1:(worker1'=worker1Fail);
endmodule
...
module _r4
  ...
  [r4dot2l8cRetry] r4=5 & r4retry_t2l8c < r4_maxRetry_t2l8c -> p_r4_t2l8c : (r4'=r4+1) + (1-p_r4_t2l8c) : (r4'=r4) & (r4retry_t2l8c' = r4retry_t2l8c+1);
  [r4dot2l8c] r4=5 & r4retry_t2l8c >= r4_maxRetry_t2l8c -> 1:(r4'=r4Fail);
  [r4dot2l8aRetry] r4=6 & r4retry_t2l8a < r4_maxRetry_t2l8a -> p_r4_t2l8a : (r4'=r4+1) + (1-p_r4_t2l8a) : (r4'=r4) & (r4retry_t2l8a' = r4retry_t2l8a+1);
  [r4dot2l8a] r4=6 & r4retry_t2l8a >= r4_maxRetry_t2l8a -> 1:(r4'=r4Fail);
  [r4dot2l8dRetry] r4=7 & r4retry_t2l8d < r4_maxRetry_t2l8d -> p_r4_t2l8d : (r4'=r4+1) + (1-p_r4_t2l8d) : (r4'=r4) & (r4retry_t2l8d' = r4retry_t2l8d+1);
  [r4dot2l8d] r4=7 & r4retry_t2l8d >= r4_maxRetry_t2l8d -> 1:(r4'=r4Fail);
  [r4dot2l8bRetry] r4=8 & r4retry_t2l8b < r4_maxRetry_t2l8b -> p_r4_t2l8b : (r4'=r4+1) + (1-p_r4_t2l8b) : (r4'=r4) & (r4retry_t2l8b' = r4retry_t2l8b+1);
  [r4dot2l8b] r4=8 & r4retry_t2l8b >= r4_maxRetry_t2l8b -> 1:(r4'=r4Fail);
  [r4dot3l8Retry] r4=9 & r4retry_t3l8 < r4_maxRetry_t3l8 -> p_r4_t3l8 : (r4'=r4+1) + (1-p_r4_t3l8) : (r4'=r4) & (r4retry_t3l8' = r4retry_t3l8+1);
  [r4dot3l8] r4=9 & r4retry_t3l8 >= r4_maxRetry_t3l8 -> 1:(r4'=r4Fail);
endmodule
