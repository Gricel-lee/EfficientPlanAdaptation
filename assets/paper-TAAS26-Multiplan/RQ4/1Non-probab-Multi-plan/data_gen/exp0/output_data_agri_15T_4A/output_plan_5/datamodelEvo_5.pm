...
module _r4
  ...
  [r4dot2l8aRetry] r4=4 & r4retry_t2l8a < r4_maxRetry_t2l8a -> p_r4_t2l8a : (r4'=r4+1) + (1-p_r4_t2l8a) : (r4'=r4) & (r4retry_t2l8a' = r4retry_t2l8a+1);
  [r4dot2l8a] r4=4 & r4retry_t2l8a >= r4_maxRetry_t2l8a -> 1:(r4'=r4Fail);
  [r4dot3l8bRetry] r4=5 & r4retry_t3l8b < r4_maxRetry_t3l8b -> p_r4_t3l8b : (r4'=r4+1) + (1-p_r4_t3l8b) : (r4'=r4) & (r4retry_t3l8b' = r4retry_t3l8b+1);
  [r4dot3l8b] r4=5 & r4retry_t3l8b >= r4_maxRetry_t3l8b -> 1:(r4'=r4Fail);
  [r4dot2l8bRetry] r4=6 & r4retry_t2l8b < r4_maxRetry_t2l8b -> p_r4_t2l8b : (r4'=r4+1) + (1-p_r4_t2l8b) : (r4'=r4) & (r4retry_t2l8b' = r4retry_t2l8b+1);
  [r4dot2l8b] r4=6 & r4retry_t2l8b >= r4_maxRetry_t2l8b -> 1:(r4'=r4Fail);
  [r4movel9] r4=7-> 1:(r4'=7+1);
  [r4dot3l9Retry] r4=8 & r4retry_t3l9 < r4_maxRetry_t3l9 -> p_r4_t3l9 : (r4'=r4+1) + (1-p_r4_t3l9) : (r4'=r4) & (r4retry_t3l9' = r4retry_t3l9+1);
  [r4dot3l9] r4=8 & r4retry_t3l9 >= r4_maxRetry_t3l9 -> 1:(r4'=r4Fail);
  [r4movel8] r4=9-> 1:(r4'=9+1);
  [r4dot2l8dRetry] r4=10 & r4retry_t2l8d < r4_maxRetry_t2l8d -> p_r4_t2l8d : (r4'=r4+1) + (1-p_r4_t2l8d) : (r4'=r4) & (r4retry_t2l8d' = r4retry_t2l8d+1);
  [r4dot2l8d] r4=10 & r4retry_t2l8d >= r4_maxRetry_t2l8d -> 1:(r4'=r4Fail);
  [r4dot3l8Retry] r4=11 & r4retry_t3l8 < r4_maxRetry_t3l8 -> p_r4_t3l8 : (r4'=r4+1) + (1-p_r4_t3l8) : (r4'=r4) & (r4retry_t3l8' = r4retry_t3l8+1);
  [r4dot3l8] r4=11 & r4retry_t3l8 >= r4_maxRetry_t3l8 -> 1:(r4'=r4Fail);
  [r4dot2l8cRetry] r4=12 & r4retry_t2l8c < r4_maxRetry_t2l8c -> p_r4_t2l8c : (r4'=r4+1) + (1-p_r4_t2l8c) : (r4'=r4) & (r4retry_t2l8c' = r4retry_t2l8c+1);
  [r4dot2l8c] r4=12 & r4retry_t2l8c >= r4_maxRetry_t2l8c -> 1:(r4'=r4Fail);
endmodule
