...
module _r3
  ...
  [r3movel8] r3=2-> 1:(r3'=2+1);
  [r3dot2l8aRetry] r3=3 & r3retry_t2l8a < r3_maxRetry_t2l8a -> p_r3_t2l8a : (r3'=r3+1) + (1-p_r3_t2l8a) : (r3'=r3) & (r3retry_t2l8a' = r3retry_t2l8a+1);
  [r3dot2l8a] r3=3 & r3retry_t2l8a >= r3_maxRetry_t2l8a -> 1:(r3'=r3Fail);
  [r3movel5] r3=4-> 1:(r3'=4+1);
  [r3dot2l5Retry] r3=5 & r3retry_t2l5 < r3_maxRetry_t2l5 -> p_r3_t2l5 : (r3'=r3+1) + (1-p_r3_t2l5) : (r3'=r3) & (r3retry_t2l5' = r3retry_t2l5+1);
  [r3dot2l5] r3=5 & r3retry_t2l5 >= r3_maxRetry_t2l5 -> 1:(r3'=r3Fail);
endmodule
