dtmc
evolve int worker1_maxRetry_t1l4 [1..1];
evolve int r3_maxRetry_t3l4 [1..1];
evolve int r3_maxRetry_t3l7 [1..1];
evolve int r3_maxRetry_t2l8a [1..1];

const double p_worker1_t1l4_ORIGINAL=1.0;
const double p_r3_t3l4_ORIGINAL=1;
const double p_r3_t3l7_ORIGINAL=1;
const double p_r3_t2l8a_ORIGINAL=0.99;

const double e = 2.718281828459045;
const double steepnessworker1_t1l4 = 3;
const double steepnessr3_t3l4 = 0.1;
...
formula p_r3_t3l4 = 2 * (1 - p_r3_t3l4_ORIGINAL) * (1 / (1 + 1/pow(e,(r3retry_t3l4 * steepnessr3_t3l4)))) + (2 * p_r3_t3l4_ORIGINAL - 1);
...
module _worker1
  ...
  [worker1movel1] worker1=2-> 1:(worker1'=2+1);
endmodule

module _r3
  r3 : [0..8];
  r3retry_t3l4 : [0..r3_maxRetry_t3l4] init 0;
  r3retry_t3l7 : [0..r3_maxRetry_t3l7] init 0;
  r3retry_t2l8a : [0..r3_maxRetry_t2l8a] init 0;

  [r3movel4] r3=0-> 1:(r3'=0+1);
  [r3dot3l4Retry] r3=1 & r3retry_t3l4 < r3_maxRetry_t3l4 -> p_r3_t3l4 : (r3'=r3+1) + (1-p_r3_t3l4) : (r3'=r3) & (r3retry_t3l4' = r3retry_t3l4+1);
  [r3dot3l4] r3=1 & r3retry_t3l4 >= r3_maxRetry_t3l4 -> 1:(r3'=r3Fail);
  [r3movel7] r3=2-> 1:(r3'=2+1);
  [r3dot3l7Retry] r3=3 & r3retry_t3l7 < r3_maxRetry_t3l7 -> p_r3_t3l7 : (r3'=r3+1) + (1-p_r3_t3l7) : (r3'=r3) & (r3retry_t3l7' = r3retry_t3l7+1);
  [r3dot3l7] r3=3 & r3retry_t3l7 >= r3_maxRetry_t3l7 -> 1:(r3'=r3Fail);
  [r3movel8] r3=4-> 1:(r3'=4+1);
...
formula r_r3_t3l4_ORIGINAL = 1;
formula r_r3_t3l4 = r_r3_t3l4_ORIGINAL * (r3retry_t3l4+1);
