...
module _worker1
  ...
  [worker1movel4] worker1=4-> 1:(worker1'=4+1);
  [worker1dot1l4Retry] worker1=5 & worker1retry_t1l4 < worker1_maxRetry_t1l4 -> p_worker1_t1l4 : (worker1'=worker1+1) + (1-p_worker1_t1l4) : (worker1'=worker1) & (worker1retry_t1l4' = worker1retry_t1l4+1);
  [worker1dot1l4] worker1=5 & worker1retry_t1l4 >= worker1_maxRetry_t1l4 -> 1:(worker1'=worker1Fail);
  [worker1movel1] worker1=6-> 1:(worker1'=6+1);
endmodule
