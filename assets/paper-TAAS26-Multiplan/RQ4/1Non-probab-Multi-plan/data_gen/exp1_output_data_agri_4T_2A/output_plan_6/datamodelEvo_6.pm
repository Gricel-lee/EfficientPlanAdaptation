...
module _r3
  ...
  [r3dot3l7Retry] r3=6 & r3retry_t3l7 < r3_maxRetry_t3l7 -> p_r3_t3l7 : (r3'=r3+1) + (1-p_r3_t3l7) : (r3'=r3) & (r3retry_t3l7' = r3retry_t3l7+1);
  [r3dot3l7] r3=6 & r3retry_t3l7 >= r3_maxRetry_t3l7 -> 1:(r3'=r3Fail);
endmodule
