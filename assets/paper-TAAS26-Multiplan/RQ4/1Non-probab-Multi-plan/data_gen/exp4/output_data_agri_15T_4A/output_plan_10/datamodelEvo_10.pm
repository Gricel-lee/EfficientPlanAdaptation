...
module _r4
  ...
  [r4dot3l9bRetry] r4=7 & r4retry_t3l9b < r4_maxRetry_t3l9b -> p_r4_t3l9b : (r4'=r4+1) + (1-p_r4_t3l9b) : (r4'=r4) & (r4retry_t3l9b' = r4retry_t3l9b+1);
  [r4dot3l9b] r4=7 & r4retry_t3l9b >= r4_maxRetry_t3l9b -> 1:(r4'=r4Fail);
  ...
  [r4dot2l8bRetry] r4=10 & r4retry_t2l8b < r4_maxRetry_t2l8b -> p_r4_t2l8b : (r4'=r4+1) + (1-p_r4_t2l8b) : (r4'=r4) & (r4retry_t2l8b' = r4retry_t2l8b+1);
  [r4dot2l8b] r4=10 & r4retry_t2l8b >= r4_maxRetry_t2l8b -> 1:(r4'=r4Fail);
  [r4dot2l8aRetry] r4=11 & r4retry_t2l8a < r4_maxRetry_t2l8a -> p_r4_t2l8a : (r4'=r4+1) + (1-p_r4_t2l8a) : (r4'=r4) & (r4retry_t2l8a' = r4retry_t2l8a+1);
  [r4dot2l8a] r4=11 & r4retry_t2l8a >= r4_maxRetry_t2l8a -> 1:(r4'=r4Fail);
  [r4dot2l8dRetry] r4=12 & r4retry_t2l8d < r4_maxRetry_t2l8d -> p_r4_t2l8d : (r4'=r4+1) + (1-p_r4_t2l8d) : (r4'=r4) & (r4retry_t2l8d' = r4retry_t2l8d+1);
  [r4dot2l8d] r4=12 & r4retry_t2l8d >= r4_maxRetry_t2l8d -> 1:(r4'=r4Fail);
endmodule
