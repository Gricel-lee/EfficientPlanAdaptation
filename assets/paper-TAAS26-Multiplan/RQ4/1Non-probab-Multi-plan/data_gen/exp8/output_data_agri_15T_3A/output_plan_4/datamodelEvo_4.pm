...
module _worker1
  ...
  [worker1dot3l7Retry] worker1=2 & worker1retry_t3l7 < worker1_maxRetry_t3l7 -> p_worker1_t3l7 : (worker1'=worker1+1) + (1-p_worker1_t3l7) : (worker1'=worker1) & (worker1retry_t3l7' = worker1retry_t3l7+1);
  [worker1dot3l7] worker1=2 & worker1retry_t3l7 >= worker1_maxRetry_t3l7 -> 1:(worker1'=worker1Fail);
endmodule
...
module _worker2
  ...
  [worker2movel9] worker2=10-> 1:(worker2'=10+1);
  ...
  [worker2dot3l9Retry] worker2=12 & worker2retry_t3l9 < worker2_maxRetry_t3l9 -> p_worker2_t3l9 : (worker2'=worker2+1) + (1-p_worker2_t3l9) : (worker2'=worker2) & (worker2retry_t3l9' = worker2retry_t3l9+1);
  [worker2dot3l9] worker2=12 & worker2retry_t3l9 >= worker2_maxRetry_t3l9 -> 1:(worker2'=worker2Fail);
endmodule
...
module _r3
  ...
  [r3dot3l9aRetry] r3=8 & r3retry_t3l9a < r3_maxRetry_t3l9a -> p_r3_t3l9a : (r3'=r3+1) + (1-p_r3_t3l9a) : (r3'=r3) & (r3retry_t3l9a' = r3retry_t3l9a+1);
  [r3dot3l9a] r3=8 & r3retry_t3l9a >= r3_maxRetry_t3l9a -> 1:(r3'=r3Fail);
