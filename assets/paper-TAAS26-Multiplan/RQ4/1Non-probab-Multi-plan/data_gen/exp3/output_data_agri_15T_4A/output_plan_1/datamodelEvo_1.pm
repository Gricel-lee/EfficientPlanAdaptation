...
const double p_worker1_t3l8_ORIGINAL=0.99;
...
const double steepnessworker1_t3l8 = 3;
...
formula p_worker1_t3l8 = 2 * (1 - p_worker1_t3l8_ORIGINAL) * (1 / (1 + 1/pow(e,(worker1retry_t3l8 * steepnessworker1_t3l8)))) + (2 * p_worker1_t3l8_ORIGINAL - 1);
...
module _worker1
  ...
  [worker1dot1l6aRetry] worker1=12 & worker1retry_t1l6a < worker1_maxRetry_t1l6a -> p_worker1_t1l6a : (worker1'=worker1+1) + (1-p_worker1_t1l6a) : (worker1'=worker1) & (worker1retry_t1l6a' = worker1retry_t1l6a+1);
  [worker1dot1l6a] worker1=12 & worker1retry_t1l6a >= worker1_maxRetry_t1l6a -> 1:(worker1'=worker1Fail);
endmodule
...
module _r3
  ...
  [r3dot2l8dRetry] r3=9 & r3retry_t2l8d < r3_maxRetry_t2l8d -> p_r3_t2l8d : (r3'=r3+1) + (1-p_r3_t2l8d) : (r3'=r3) & (r3retry_t2l8d' = r3retry_t2l8d+1);
  [r3dot2l8d] r3=9 & r3retry_t2l8d >= r3_maxRetry_t2l8d -> 1:(r3'=r3Fail);
endmodule
...
formula r_worker1_t3l8_ORIGINAL = 5;
formula r_worker1_t3l8 = r_worker1_t3l8_ORIGINAL * (worker1retry_t3l8+1);
