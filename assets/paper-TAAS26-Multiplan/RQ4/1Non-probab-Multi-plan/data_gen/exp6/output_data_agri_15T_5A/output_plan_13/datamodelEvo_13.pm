...
module _r3
  ...
  [r3dot3l8Retry] r3=12 & r3retry_t3l8 < r3_maxRetry_t3l8 -> p_r3_t3l8 : (r3'=r3+1) + (1-p_r3_t3l8) : (r3'=r3) & (r3retry_t3l8' = r3retry_t3l8+1);
  [r3dot3l8] r3=12 & r3retry_t3l8 >= r3_maxRetry_t3l8 -> 1:(r3'=r3Fail);
  [r3dot2l8cRetry] r3=13 & r3retry_t2l8c < r3_maxRetry_t2l8c -> p_r3_t2l8c : (r3'=r3+1) + (1-p_r3_t2l8c) : (r3'=r3) & (r3retry_t2l8c' = r3retry_t2l8c+1);
  [r3dot2l8c] r3=13 & r3retry_t2l8c >= r3_maxRetry_t2l8c -> 1:(r3'=r3Fail);
endmodule
