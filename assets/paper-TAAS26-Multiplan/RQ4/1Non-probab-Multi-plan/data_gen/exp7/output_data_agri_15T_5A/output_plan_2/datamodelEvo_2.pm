...
module _r5
  ...
  [r5dot2l8bRetry] r5=4 & r5retry_t2l8b < r5_maxRetry_t2l8b -> p_r5_t2l8b : (r5'=r5+1) + (1-p_r5_t2l8b) : (r5'=r5) & (r5retry_t2l8b' = r5retry_t2l8b+1);
  [r5dot2l8b] r5=4 & r5retry_t2l8b >= r5_maxRetry_t2l8b -> 1:(r5'=r5Fail);
  [r5dot3l8Retry] r5=5 & r5retry_t3l8 < r5_maxRetry_t3l8 -> p_r5_t3l8 : (r5'=r5+1) + (1-p_r5_t3l8) : (r5'=r5) & (r5retry_t3l8' = r5retry_t3l8+1);
  [r5dot3l8] r5=5 & r5retry_t3l8 >= r5_maxRetry_t3l8 -> 1:(r5'=r5Fail);
  ...
  [r5dot2l8aRetry] r5=9 & r5retry_t2l8a < r5_maxRetry_t2l8a -> p_r5_t2l8a : (r5'=r5+1) + (1-p_r5_t2l8a) : (r5'=r5) & (r5retry_t2l8a' = r5retry_t2l8a+1);
  [r5dot2l8a] r5=9 & r5retry_t2l8a >= r5_maxRetry_t2l8a -> 1:(r5'=r5Fail);
endmodule
