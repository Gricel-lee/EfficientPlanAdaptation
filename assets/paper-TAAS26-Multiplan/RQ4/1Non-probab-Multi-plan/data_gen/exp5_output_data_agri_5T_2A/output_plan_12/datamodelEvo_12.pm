...
evolve int r3_maxRetry_t3l4 [1..10];
...
const double p_r3_t3l4_ORIGINAL=0.97;
...
module _r3
  ...
  [r3movel5] r3=2-> 1:(r3'=2+1);
  [r3dot2l5Retry] r3=3 & r3retry_t2l5 < r3_maxRetry_t2l5 -> p_r3_t2l5 : (r3'=r3+1) + (1-p_r3_t2l5) : (r3'=r3) & (r3retry_t2l5' = r3retry_t2l5+1);
  [r3dot2l5] r3=3 & r3retry_t2l5 >= r3_maxRetry_t2l5 -> 1:(r3'=r3Fail);
