...
module _r4
  ...
  [r4dot2l8dRetry] r4=8 & r4retry_t2l8d < r4_maxRetry_t2l8d -> p_r4_t2l8d : (r4'=r4+1) + (1-p_r4_t2l8d) : (r4'=r4) & (r4retry_t2l8d' = r4retry_t2l8d+1);
  [r4dot2l8d] r4=8 & r4retry_t2l8d >= r4_maxRetry_t2l8d -> 1:(r4'=r4Fail);
  ...
  [r4movel9] r4=10-> 1:(r4'=10+1);
  [r4dot3l9bRetry] r4=11 & r4retry_t3l9b < r4_maxRetry_t3l9b -> p_r4_t3l9b : (r4'=r4+1) + (1-p_r4_t3l9b) : (r4'=r4) & (r4retry_t3l9b' = r4retry_t3l9b+1);
  [r4dot3l9b] r4=11 & r4retry_t3l9b >= r4_maxRetry_t3l9b -> 1:(r4'=r4Fail);
  [r4dot3l9Retry] r4=12 & r4retry_t3l9 < r4_maxRetry_t3l9 -> p_r4_t3l9 : (r4'=r4+1) + (1-p_r4_t3l9) : (r4'=r4) & (r4retry_t3l9' = r4retry_t3l9+1);
  [r4dot3l9] r4=12 & r4retry_t3l9 >= r4_maxRetry_t3l9 -> 1:(r4'=r4Fail);
endmodule
