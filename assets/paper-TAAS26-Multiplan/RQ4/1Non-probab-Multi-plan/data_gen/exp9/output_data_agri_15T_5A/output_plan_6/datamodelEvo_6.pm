...
module _r5
  ...
  [r5movel9] r5=7-> 1:(r5'=7+1);
  [r5dot3l9Retry] r5=8 & r5retry_t3l9 < r5_maxRetry_t3l9 -> p_r5_t3l9 : (r5'=r5+1) + (1-p_r5_t3l9) : (r5'=r5) & (r5retry_t3l9' = r5retry_t3l9+1);
  [r5dot3l9] r5=8 & r5retry_t3l9 >= r5_maxRetry_t3l9 -> 1:(r5'=r5Fail);
  [r5dot3l9bRetry] r5=9 & r5retry_t3l9b < r5_maxRetry_t3l9b -> p_r5_t3l9b : (r5'=r5+1) + (1-p_r5_t3l9b) : (r5'=r5) & (r5retry_t3l9b' = r5retry_t3l9b+1);
  [r5dot3l9b] r5=9 & r5retry_t3l9b >= r5_maxRetry_t3l9b -> 1:(r5'=r5Fail);
  [r5movel8] r5=10-> 1:(r5'=10+1);
  [r5dot3l8Retry] r5=11 & r5retry_t3l8 < r5_maxRetry_t3l8 -> p_r5_t3l8 : (r5'=r5+1) + (1-p_r5_t3l8) : (r5'=r5) & (r5retry_t3l8' = r5retry_t3l8+1);
  [r5dot3l8] r5=11 & r5retry_t3l8 >= r5_maxRetry_t3l8 -> 1:(r5'=r5Fail);
  [r5dot2l8dRetry] r5=12 & r5retry_t2l8d < r5_maxRetry_t2l8d -> p_r5_t2l8d : (r5'=r5+1) + (1-p_r5_t2l8d) : (r5'=r5) & (r5retry_t2l8d' = r5retry_t2l8d+1);
  [r5dot2l8d] r5=12 & r5retry_t2l8d >= r5_maxRetry_t2l8d -> 1:(r5'=r5Fail);
