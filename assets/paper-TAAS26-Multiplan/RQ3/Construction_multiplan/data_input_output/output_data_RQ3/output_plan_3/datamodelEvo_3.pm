...
module _h1
  ...
  [h1movel4] h1=0-> 1:(h1'=0+1);
  [h1dot3_bzaRetry] h1=1 & h1retry_t3_bza < h1_maxRetry_t3_bza -> p_h1_t3_bza : (h1'=h1+1) + (1-p_h1_t3_bza) : (h1'=h1) & (h1retry_t3_bza' = h1retry_t3_bza+1);
  [h1dot3_bza] h1=1 & h1retry_t3_bza >= h1_maxRetry_t3_bza -> 1:(h1'=h1Fail);
  [h1movel8] h1=2-> 1:(h1'=2+1);
  [h1dot2_ip1Retry] h1=3 & h1retry_t2_ip1 < h1_maxRetry_t2_ip1 -> p_h1_t2_ip1 : (h1'=h1+1) + (1-p_h1_t2_ip1) : (h1'=h1) & (h1retry_t2_ip1' = h1retry_t2_ip1+1);
  [h1dot2_ip1] h1=3 & h1retry_t2_ip1 >= h1_maxRetry_t2_ip1 -> 1:(h1'=h1Fail);
...
module _r2
  ...
  [r2movel9] r2=2-> 1:(r2'=2+1);
  [r2dot4_wcp1Retry] r2=3 & r2retry_t4_wcp1 < r2_maxRetry_t4_wcp1 -> p_r2_t4_wcp1 : (r2'=r2+1) + (1-p_r2_t4_wcp1) : (r2'=r2) & (r2retry_t4_wcp1' = r2retry_t4_wcp1+1);
  [r2dot4_wcp1] r2=3 & r2retry_t4_wcp1 >= r2_maxRetry_t4_wcp1 -> 1:(r2'=r2Fail);
endmodule
